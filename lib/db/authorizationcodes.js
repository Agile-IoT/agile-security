...
exports.save = function(code, clientID, redirectURI, userID, authType, token, done) {
  console.log("////////////////////////////////////// storing auth code: "+JSON.stringify( { clientID: clientID, redirectURI: redirectURI, userID: userID }+" actual code - "+code));
  // TODO remove authcodes after they have been exchanged!
  codes[code] = { clientID: clientID, redirectURI: redirectURI, userID: userID , authType: authType, token:token};
  return done(null);
};
